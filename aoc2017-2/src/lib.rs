...
mod tests {
    ...
    #[test]
    fn case_1_star_2() {
        assert_eq!(checksum("5 9 2 8
                             9 4 7 3
                             3 8 6 5", 2), 9);
    }
    #[test]
    fn star_1_for_real() {
        assert_eq!(checksum("3751   3769    2769    2039    2794    240 3579    1228    4291    220 324 3960    211 1346    237 1586
                            ...
                            214 221 265 766 959 1038    226 1188    1122    117 458 1105    1285    1017    274 281", 1), 36174);
    }
    #[test]
    fn star_2_for_real() {
        assert_eq!(checksum("3751   3769    2769    2039    2794    240 3579    1228    4291    220 324 3960    211 1346    237 1586
                            ...
                            2602    216 495 3733    183 4688    2893    4042    3066    3810    189 4392    3900    4321    2814    159
                            166 136 80  185 135 78  177 123 82  150 121 145 115 63  68  24
                            214 221 265 766 959 1038    226 1188    1122    117 458 1105    1285    1017    274 281", 2), 244);
    }
}
